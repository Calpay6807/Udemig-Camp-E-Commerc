                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div className="product-block">
                                ...
                                <div className="product-content">
                                    <h5><a href="#" claclassNamess="product-title">Google Pixel <strong>(128GB, Black)</strong></a></h5>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div className="product-block">
                                ...
                                <div className="product-content">
                                    ...
                                    <div class="product-meta"><a href="#" className="product-price">$1500</a>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div className="product-block">
                                ...
                                <div className="product-content">
                                    ...
                                    <div className="shopping-btn">
                                        <a href="#" className="assets/product-btn btn-like">
